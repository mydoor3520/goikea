		...
		<section class="section" style="font-size:0;">
			<div id="left">
				...
				<div id="info">
					...
					<hr>
					<p>이름</p>
					<input id="r_name" type="text" class="input-control" name="rcv_name" style="width:187px;" required>
					
					<p>주소</p>
					<input type="number" id="postcode2" class="input-control" name="rcv_post"  required>
					<input type="button" class="button-control" onclick="receiver_findPost()" value="주소찾기">
					<br>
					<input type="text" id="address3"  class="input-control" name="rcv_addr1"  required>
					<input type="text" id="address4"  class="input-control" name="rcv_addr2"  required>
					<br>
					
					<p class="phone" >전화번호</p>
					<p class="email">이메일</p>
					<br>
					<input id="r_phone" type="text" class="input-control" name="rcv_phone" style="width:400px;"  required>
					<input id="r_email" type="text" class="input-control" name="rcv_email" style="width:400px;"  required>
				...
				<c:forEach var="list" items="${order_list}" varStatus="status">
					<c:forEach var="map" items="${list }">
						<c:if test="${chk_name ne map.P_NAME }">
							<p>
								<img src="${pageContext.request.contextPath}/resources/images/page_contents/${map.IMG}" style="height: 200px; width: 200px;">
								<br>
								${map.P_NAME }
							</p>
				...
				<div class="pay_method" style="font-size:0;">
					<ul>
						...
						<li>
							...
							<input type="radio" id="pay_method_account" name="pay_radio" required>
						</li>
					</ul>
				</div>
				<input type="submit" value="결제하기" style="border: 1px solid black;width:100%;height:50px;line-height:50px;margin-top: 30px;background-color:white;border:1px solid red;pointer:cursor;font-size:20px;font-weight:bold;" >
