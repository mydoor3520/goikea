...
public class Paging_company {
	...
	public Map<String,Object> get_listPage(int listcount, int pagecount, int page){
		...
		int totalCount = company_total.list_totalCount();//총 게시물 수
	...
	public Map<String,Object> get_searchListPage(int listcount, int pagecount, int page, String searchOption, String keyword){
		...
		int totalCount = company_total.listSelect_totalCount(searchmap);//총 게시물 수
		System.out.println("Paging_company => get_searchListPage => totalCount = "+totalCount);
		
		map = paging(listcount, pagecount, page, totalCount, map);	//페이지 처리 메소드 시행
		map.put("searchOption", searchOption);
		map.put("keyword", keyword);
		
		System.out.println("Paging_company => get_searchListPage => searchOption, keyword = "+searchOption+keyword);
	...
	public Map<String,Object> get_searchListPageAll(int listcount, int pagecount, int page, String keyword){
		...
		int totalCount = company_total.listSelectAll_totalCount(searchmap);//총 게시물 수
		System.out.println("Paging_company => get_searchListPage => totalCount = "+totalCount);
		
		map = paging(listcount, pagecount, page, totalCount, map);	//페이지 처리 메소드 시행
		map.put("keyword", keyword);
		
		System.out.println("Paging_company => get_searchListPage => keyword = "+keyword);
	...
	public Map<String, Object> paging(int listcount, int pagecount, int page, int totalCount, Map<String, Object> map) {
		...
		System.out.println("Paging_company => get_searchListPage => startArticle = "+map.get("startArticle"));
		System.out.println("Paging_company => get_searchListPage => endArticle = "+map.get("endArticle"));
